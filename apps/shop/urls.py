...
from .views import ShopInfoView, AddCartView, ProductInfoView, CheckoutPageView, CartView
...
urlpatterns = [
    ...
    path('cart/<int:goods_id>/<int:quantity>', AddCartView.as_view(), name='update_cart'),
